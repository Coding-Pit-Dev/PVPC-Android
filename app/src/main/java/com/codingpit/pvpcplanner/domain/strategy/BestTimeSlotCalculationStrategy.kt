...
class BestTimeSlotCalculationStrategy @Inject constructor() : PriceCalculationStrategy {

    override fun calculateBestTimeSlot(device: Device, prices: List<PVPCModel>): TimeSlot {
