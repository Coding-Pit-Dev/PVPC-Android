...
class GetPricesFlowTest {
    ...
    @Test
    fun `invoke with specific date returns prices flow from repository`() =
        runTest {
            // Arrange
            val date = "2023-10-15"
            val expectedPrices =
    ...
    @Test
    fun `invoke with empty date uses default date from date checker`() =
        runTest {
            // Arrange
    ...
    @Test
    fun `invoke with no parameters uses default date from date checker`() =
        runTest {
            // Arrange
    ...
    @Test
    fun `invoke returns failure flow when repository fails`() =
        runTest {
            // Arrange
            val date = "2023-10-15"
    ...
    @Test
    fun `invoke handles repository exception with default date`() =
        runTest {
            // Arrange
            val defaultDate = LocalDate.of(2023, 10, 15)
            val expectedDateString = "2023-10-15"
    ...
    @Test
    fun `invoke handles valid future date with specific date`() =
        runTest {
            // Arrange
    ...
    @Test
    fun `invoke handles empty prices list`() =
        runTest {
            // Arrange
            val date = "2023-10-15"
