...
class UpdateDeviceTest {
    ...
    @Test
    fun `invoke updates device in repository`() = runTest {
        // Arrange
    ...
    @Test
    fun `invoke updates device with all properties`() = runTest {
        // Arrange
        val device = Device(
            id = 42,
    ...
    @Test
    fun `invoke updates device with minimal hours`() = runTest {
        // Arrange
    ...
    @Test
    fun `invoke handles validation exceptions`() = runTest {
        // Arrange
