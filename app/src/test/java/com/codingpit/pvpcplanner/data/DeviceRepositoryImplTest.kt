...
class DeviceRepositoryImplTest {
    ...
    @Test
    fun `getDevices returns flow from local data source`() =
        runTest {
            // Arrange
            val devices =
                listOf(
    ...
    @Test
    fun `addDevice calls local data source saveDevice`() =
        runTest {
            // Arrange
    ...
    @Test
    fun `deleteDevice calls local data source deleteDevice`() =
        runTest {
            // Arrange
            val device = Device(1, "Washing Machine", 3, "washing_machine")
    ...
    @Test
    fun `updateDevice calls local data source updateDevice`() =
        runTest {
            // Arrange
    ...
    @Test
    fun `addDevice propagates exception from local data source`() =
        runTest {
            // Arrange
            val device = Device(1, "Washing Machine", 3, "washing_machine")
    ...
    @Test
    fun `deleteDevice propagates exception from local data source`() =
        runTest {
            // Arrange
            val device = Device(1, "Washing Machine", 3, "washing_machine")
    ...
    @Test
    fun `updateDevice propagates exception from local data source`() =
        runTest {
            // Arrange
            val device = Device(1, "Updated Machine", 4, "updated_icon")
