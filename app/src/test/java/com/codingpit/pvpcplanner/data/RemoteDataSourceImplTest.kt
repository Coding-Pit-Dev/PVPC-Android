...
class RemoteDataSourceImplTest {
    ...
    private fun buildDto(day: String, hour: String, pcb: String = "100,00000", cym: String = "10,00000") =
        PVPCDTO(
            day = day,
            hour = hour,
            pcb = pcb,
    ...
    @Test
    fun `getPrices maps DTO list to domain models`() =
        runTest {
            val dtos =
                listOf(
    ...
    @Test
    fun `getPrices returns empty list when API returns empty pvpc list`() =
        runTest {
    ...
    @Test
    fun `getPrices propagates IOException from API`() =
        runTest {
    ...
    @Test
    fun `getPrices propagates RuntimeException from API`() =
        runTest {
    ...
    @Test
    fun `getPrices passes date parameter to API unchanged`() =
        runTest {
            val date = "2026-04-30"
