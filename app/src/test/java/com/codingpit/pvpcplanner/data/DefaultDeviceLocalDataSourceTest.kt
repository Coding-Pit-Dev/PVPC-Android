...
class DefaultDeviceLocalDataSourceTest {
    ...
    @Test
    fun `getDevices maps entities to domain models`() =
        runTest {
            val entities =
                listOf(
    ...
    @Test
    fun `getDevices emits empty list when no devices`() =
        runTest {
    ...
    @Test
    fun `saveDevice inserts entity to DAO`() =
        runTest {
    ...
    @Test
    fun `updateDevice updates entity in DAO`() =
        runTest {
    ...
    @Test
    fun `deleteDevice deletes entity from DAO`() =
        runTest {
    ...
    @Test
    fun `saveDevice propagates DAO exception`() =
        runTest {
            val device = Device(0, "Washing Machine", 3, "washing_machine", 2000, "laundry")
