...
class PriceIntegrationTest {
    ...
    @Test
    fun `complete flow - local cache hit returns data without remote call`() =
        runTest {
            // Arrange
            val date = "2023-10-15"
            val cachedPrices =
    ...
    @Test
    fun `complete flow - cache miss triggers remote fetch and local save`() =
        runTest {
            // Arrange
            val date = "2023-10-15"
            val remotePrices =
    ...
    @Test
    fun `complete flow - remote failure returns error result`() =
        runTest {
            // Arrange
            val date = "2023-10-15"
    ...
    @Test
    fun `complete flow - local failure returns error result`() =
        runTest {
            // Arrange
            val date = "2023-10-15"
    ...
    @Test
    fun `complete flow - use case with default date calls repository correctly`() =
        runTest {
            // Arrange
            val expectedPrices =
                listOf(
    ...
    @Test
    fun `complete flow - multiple sequential calls use cache correctly`() =
        runTest {
            // Arrange
            val date = "2023-10-15"
            val cachedPrices =
