...
class PriceCalculationIntegrationTest {
    ...
    @Test
    fun `complete workflow - fetch prices and calculate best time slot for device`() =
        runTest {
            // Arrange
            val date = "2023-10-15"
    ...
    @Test
    fun `price flow integration with date checker`() =
        runTest {
            // Arrange
    ...
    @Test
    fun `complete device optimization scenario - multiple devices different hours`() =
        runTest {
    ...
    @Test
    fun `price calculation with edge case - device longer than available prices`() =
        runTest {
            // Arrange
            val date = "2023-10-15"
            val limitedPrices =
    ...
    @Test
    fun `complete workflow with remote fetch and calculation`() =
        runTest {
    ...
    @Test
    fun `price calculation handles equal prices correctly`() =
        runTest {
            // Arrange
            val date = "2023-10-15"
    ...
    @Test
    fun `flow integration with error recovery`() =
        runTest {
            // Arrange
            val defaultDate = LocalDate.of(2023, 10, 15)
