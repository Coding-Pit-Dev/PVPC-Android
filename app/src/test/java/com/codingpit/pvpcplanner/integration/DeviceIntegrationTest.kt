...
class DeviceIntegrationTest {
    ...
    @Test
    fun `complete CRUD flow for devices`() =
        runTest {
            // Arrange
            val initialDevices =
                listOf(
            ...
            every { mockLocalDataSource.getDevices() } returns flowOf(initialDevices) andThen
                flowOf(
    ...
    @Test
    fun `device flow emits updates reactively`() =
        runTest {
            // Arrange
            val device1 = Device(1, "Device 1", 2, "icon1")
            val device2 = Device(2, "Device 2", 3, "icon2")

            every { mockLocalDataSource.getDevices() } returns
                flowOf(
                    emptyList(),
                    listOf(device1),
    ...
    @Test
    fun `add device handles validation errors`() =
        runTest {
            // Arrange
    ...
    @Test
    fun `update device handles not found errors`() =
        runTest {
            // Arrange
    ...
    @Test
    fun `delete device handles constraint violations`() =
        runTest {
            // Arrange
    ...
    @Test
    fun `complete device lifecycle with realistic data`() =
        runTest {
    ...
    @Test
    fun `device operations maintain data consistency`() =
        runTest {
            // Arrange
    ...
    @Test
    fun `batch device operations work correctly`() =
        runTest {
            // Arrange
            val devices =
                listOf(
