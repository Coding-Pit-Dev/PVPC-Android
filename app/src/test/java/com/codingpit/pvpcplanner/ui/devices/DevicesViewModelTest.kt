...
class DevicesViewModelTest {
    ...
    fun setup() {
        ...
        viewModel =
            DevicesViewModel(
                ...
                calculateDeviceCost = mockCalculateDeviceCost,
    ...
    @Test
    fun `getBestSlot returns first slot when all prices are equal`() =
        runTest {
            // Arrange
    ...
    @Test
    fun `getBestSlot finds cheapest consecutive slot for 1-hour device`() =
        runTest {
            // Arrange
    ...
    @Test
    fun `getBestSlot finds cheapest consecutive slot for 2-hour device`() =
        runTest {
            // Arrange
            val device = Device(1, "Test Device", 2, "test_icon")
            val prices =
    ...
    @Test
    fun `getBestSlot finds cheapest consecutive slot for 3-hour device`() =
        runTest {
            // Arrange
    ...
    @Test
    fun `getBestSlot handles minimum duration device with single price`() =
        runTest {
            // Arrange
            val device = Device(1, "Test Device", 1, "test_icon")
            val prices =
    ...
    @Test
    fun `getBestSlot handles device duration equal to available slots`() =
        runTest {
            // Arrange
            val device = Device(1, "Test Device", 3, "test_icon")
            val prices =
    ...
    @Test
    fun `getBestSlot prefers earlier slot when prices are tied`() =
        runTest {
            // Arrange
            val device = Device(1, "Test Device", 2, "test_icon")
            val prices =
    ...
    @Test
    fun `viewModel initialization works correctly`() =
        runTest {
    ...
    @Test
    fun `viewModel handles device operations correctly`() =
        runTest {
